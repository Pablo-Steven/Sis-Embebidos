/*
  ...
  * OBJETIVO: Realizar lecturas del conversor análogo digital y luego apagarlo por el tiempo establecido por el usuario funciones:
  ...
  *           usart
  *           all
  *           https://www.nongnu.org/avr-libc/user- manual/group avr power.html
